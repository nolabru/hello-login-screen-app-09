...
const PsychologistCompaniesContainer: React.FC = () => {
  ...
  return <div className="p-6">
      ...
      {pendingCompanies.length > 0 && <div className="mb-8">
          ...
          <CompanyList companies={pendingCompanies} isLoading={isLoading} onViewDetails={handleViewCompanyDetails} refreshCompanies={loadCompanies} listType="pending" />
        </div>}

      {requestedCompanies.length > 0 && <div className="mb-8">
          ...
          <CompanyList companies={requestedCompanies} isLoading={isLoading} onViewDetails={handleViewCompanyDetails} refreshCompanies={loadCompanies} listType="requested" />
        </div>}
      ...
      <CompanySearchDialog open={isSearchDialogOpen} onOpenChange={setIsSearchDialogOpen} searchQuery={searchQuery} onSearchQueryChange={setSearchQuery} onSearch={() => handleSearchCompanies(searchQuery)} isSearching={isSearching} searchResults={searchResults} onRequestConnection={handleRequestConnection} />

      {/* Dialog de detalhes da empresa */}
      <CompanyDetailDialog open={isDetailDialogOpen} onOpenChange={setIsDetailDialogOpen} company={selectedCompany} />
    </div>;
};
