...
const CompanyComplianceReport = () => {
  ...
  const tabGroups = [{
    ...
    tabs: ["companyInfo", "execSummary"]
  }, {
    id: "policies",
    label: "Políticas e Programas",
    tabs: ["mentalHealthPolicies", "programs"]
  }, {
    id: "support",
    label: "Suporte e Flexibilidade",
    tabs: ["supportProtocols", "workplaceFlex"]
  }, {
    id: "results",
    label: "Resultados e Planos",
    tabs: ["communication", "indicators", "challenges", "attachments"]
  }];
