...
const CompanyRegistration = () => {
  const [step, setStep] = useState('company'); // 'company' or 'responsible'
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-8">
        <Card className="w-full max-w-4xl bg-white rounded-xl shadow-lg overflow-hidden">
          <CardContent className="p-8">
            ...
            <p className="text-gray-600 mb-8">Preencha os dados para criar uma conta empresarial</p>

            <div className="flex gap-4 mb-8">
              <button
                className={`flex-1 py-3 text-center rounded-lg transition ${step === 'company' 
                  ? 'bg-portal-purple bg-opacity-10 text-portal-purple border-b-2 border-portal-purple' 
              ...
              <button
                className={`flex-1 py-3 text-center rounded-lg transition ${step === 'responsible' 
                  ? 'bg-portal-purple bg-opacity-10 text-portal-purple border-b-2 border-portal-purple' 
                  : 'text-gray-500 hover:bg-gray-100'}`}
                ...
                <div className="flex justify-between">
                  ...
                  <button
                    ...
                    onClick={() => {
                      toast({
                        title: "Formulário enviado",
                        description: "O cadastro será finalizado na próxima implementação"
                      });
                    }}
                    className="px-6 py-3 bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition"
                  >
