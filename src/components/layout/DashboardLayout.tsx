...
import { Home, Users, Building2, Settings, LogOut, Menu, X } from 'lucide-react';
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className={`${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 fixed md:relative z-20 w-64 h-full bg-white shadow-md transition-transform duration-300 ease-in-out`}>
          ...
          <div className="p-4 border-t">
            <button onClick={handleLogout} className="flex items-center w-full px-4 py-3 text-sm text-portal-purple hover:bg-purple-50 rounded-md font-medium">
