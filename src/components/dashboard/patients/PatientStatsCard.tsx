      ...
      <CardContent className="p-6">
        <div className="flex items-center justify-between">
          <div className="space-y-2">
            ...
            {loading ? <Skeleton className="h-10 w-16" /> : <div className="text-3xl font-semibold text-gray-800">{activePatients}</div>}
            <p className="text-xs text-gray-500">Total de Pacientes Ativos</p>
          </div>
