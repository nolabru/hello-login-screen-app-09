      ...
      <Tabs defaultValue="active" value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value="active">
          ...
          {!loading && filteredPatients.length === 0 && activeTab === 'active' && <div className="flex flex-col items-center justify-center p-12 bg-white rounded-lg border">
              ...
              <p className="text-center max-w-md text-sm font-normal text-gray-500">
        ...
        <TabsContent value="all">
          ...
          {!loading && filteredPatients.length === 0 && activeTab === 'all' && <div className="flex flex-col items-center justify-center p-12 bg-white rounded-lg border">
              <h3 className="font-medium mb-2 text-lg text-neutral-700">Nenhum Paciente Encontrado</h3>
              <p className="text-gray-500 text-center max-w-md text-sm font-normal">
