      ...
      try {
        ...
        const mappedActivities = associations.map(assoc => {
          ...
          if (isToday(date)) {
            ...
            dateFormatted = format(date, "d 'de' MMMM, HH:mm", {
              locale: ptBR
            });
          }
          return {
  ...
  return <Card className="w-full">
      <CardContent className="p-6">
        ...
        {loading ? <div className="space-y-4">
          ...
          </div> : activities.length > 0 ? <div className="space-y-4">
            {activities.map(activity => <div key={activity.id} className="flex items-center gap-3 border-b border-gray-100 pb-3">
